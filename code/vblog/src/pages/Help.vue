                                    ...
                                    <div class="el-carousel">
                                        <div class="el-carousel__container" style="height: 352px;"><button type="button" class="el-carousel__arrow el-carousel__arrow--left" style="display: none;"><i class="el-icon-arrow-left"></i></button><button type="button" class="el-carousel__arrow el-carousel__arrow--right" style="display: none;"><i class="el-icon-arrow-right"></i></button>
                                            <div class="el-carousel__item is-active is-animating" style="transform: translateX(0px) scale(1);">
                                                <!---->
                                                <div style="border-radius: 5px; border: 1px solid rgb(235, 238, 245); height: 350px;"><img src="/static/img/deploy0.aaa30ac.png" style="width: 100%; height: 350px;"></div>
                                            </div>
                                            <div class="el-carousel__item" style="transform: translateX(716px) scale(1);">
                                                <!---->
                                                <div style="border-radius: 5px; border: 1px solid rgb(235, 238, 245); height: 350px;"><img src="/static/img/deploy1.75fd811.png" style="width: 100%; height: 350px;"></div>
                                            </div>
                                            <div class="el-carousel__item" style="transform: translateX(-716px) scale(1);">
                                                <!---->
                                                <div style="border-radius: 5px; border: 1px solid rgb(235, 238, 245); height: 350px;"><img src="/static/img/deploy2.6d80b32.png" style="width: 100%; height: 350px;"></div>
                                            </div>
                                        </div>
                                        <ul class="el-carousel__indicators">
                                            <li class="el-carousel__indicator is-active"><button class="el-carousel__button">
                                                    <!----></button></li>
                                            <li class="el-carousel__indicator"><button class="el-carousel__button">
                                                    <!----></button></li>
                                            <li class="el-carousel__indicator"><button class="el-carousel__button">
                                                    <!----></button></li>
                                        </ul>
                                    ...
                                    <div class="el-steps el-steps--horizontal" style="margin-top: 20px;">
                                        <div class="el-step is-horizontal is-center" style="flex-basis: 33.3333%; margin-right: 0px;">
                                            <div class="el-step__head is-process">
                                                <div class="el-step__line" style="margin-right: 0px;"><i class="el-step__line-inner" style="transition-delay: 0ms; border-width: 0px; width: 0%;"></i></div>
                                            ...
                                            <div class="el-step__main">
                                                ...
                                                <div class="el-step__description is-process">https://github.com/GitHub-Laziji/GitHub-Laziji.github.io</div>
                                            </div>
                                        </div>
                                        <div class="el-step is-horizontal is-center" style="flex-basis: 33.3333%; margin-right: 0px;">
                                            ...
                                            <div class="el-step__main">
                                                ...
                                                <div class="el-step__description is-wait">将 /static/configuration.json 中的 githubUsername 改为自己的</div>
                                            </div>
                                        </div>
                                ...
                                <div class="el-collapse-item__content">
                                    <div class="el-carousel">
                                        <div class="el-carousel__container" style="height: 352px;"><button type="button" class="el-carousel__arrow el-carousel__arrow--left" style="display: none;"><i class="el-icon-arrow-left"></i></button><button type="button" class="el-carousel__arrow el-carousel__arrow--right" style="display: none;"><i class="el-icon-arrow-right"></i></button>
                                            <div class="el-carousel__item is-active is-animating" style="transform: translateX(0px) scale(1);">
                                                <!---->
                                                <div style="border-radius: 5px; border: 1px solid rgb(235, 238, 245); height: 350px;"><img src="/static/img/use0.61c0f0e.png" style="width: 100%; height: 350px;"></div>
                                            </div>
                                            <div class="el-carousel__item" style="transform: translateX(0px) scale(1);">
                                                <!---->
                                                <div style="border-radius: 5px; border: 1px solid rgb(235, 238, 245); height: 350px;"><img src="/static/img/use1.18f36b8.png" style="width: 100%; height: 350px;"></div>
                                            </div>
                                            <div class="el-carousel__item" style="transform: translateX(0px) scale(1);">
                                                <!---->
                                                <div style="border-radius: 5px; border: 1px solid rgb(235, 238, 245); height: 350px;"><img src="/static/img/use2.449ac15.png" style="width: 100%; height: 350px;"></div>
                                            </div>
                                        </div>
                                        <ul class="el-carousel__indicators">
                                            <li class="el-carousel__indicator is-active"><button class="el-carousel__button">
